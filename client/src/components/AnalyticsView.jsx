...
function AnalyticsView({ jobs = [], applications = [] }) {
  ...
  return (
    <div className="flex flex-col gap-6">
      {/* Header */}
      <div className="bg-[#14192a]/80 border border-slate-700/60 rounded-3xl p-6 shadow-xl flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <div className="flex items-center gap-2">
            <h2 className="text-2xl font-extrabold text-slate-100 tracking-tight">Báo Cáo & Phân Tích Tuyển Dụng AI (ATS Analytics)</h2>
        ...
        <div className="flex items-center gap-2">
          ...
          <select className="bg-[#0d1117] border border-slate-700/60 rounded-xl px-3 py-1.5 text-xs text-slate-100 focus:outline-none focus:border-orange-500">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          ...
          const Icon = kpi.icon;
          return (
            <div key={idx} className="bg-[#14192a]/80 border border-slate-700/60 rounded-2xl p-5 shadow-lg flex flex-col justify-between">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-[#14192a]/80 border border-slate-700/60 rounded-3xl p-6 shadow-xl flex flex-col justify-between gap-5">
          <div className="border-b border-slate-700/60/80 pb-4">
          ...
          <div className="flex flex-col gap-4">
            <div>
              <div className="flex justify-between text-xs font-bold mb-1.5">
                ...
                <span className="text-slate-100 font-mono">{highMatch} hồ sơ ({totalApps > 0 ? Math.round((highMatch/totalApps)*100) : 0}%)</span>
              </div>
            ...
            <div>
              <div className="flex justify-between text-xs font-bold mb-1.5">
                ...
                <span className="text-slate-100 font-mono">{mediumMatch} hồ sơ ({totalApps > 0 ? Math.round((mediumMatch/totalApps)*100) : 0}%)</span>
              </div>
              <div className="w-full h-3 bg-slate-800 rounded-full overflow-hidden">
            ...
            <div>
              <div className="flex justify-between text-xs font-bold mb-1.5">
                ...
                <span className="text-slate-100 font-mono">{lowMatch} hồ sơ ({totalApps > 0 ? Math.round((lowMatch/totalApps)*100) : 0}%)</span>
              </div>
              <div className="w-full h-3 bg-slate-800 rounded-full overflow-hidden">
          ...
          <div className="bg-[#0d1117]/60 p-3.5 rounded-2xl border border-slate-700/60 text-xs text-slate-300">
